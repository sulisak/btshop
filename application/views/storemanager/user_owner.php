<div class="col-md-10 col-sm-9" ng-app="firstapp" ng-controller="Index">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <input type="text" ng-model="search" name="" placeholder="<?=$lang_search?>" class="form-control"
                style="width: 200px;">
            <br />
                    ...
                    <tr ng-repeat="x in list | filter:search">
                        ...
                        <td>
                            ...
                            <span ng-if="x.user_type=='9'"><?php echo $lang_smuo_3;?>
                                ...
                                <b ng-repeat="v in vendorlist"
                                    ng-if="v.supplier_id==x.supplier_id">({{v.supplier_name}})</b>
                            </span>
                        ...
                        <td>
                            <button ng-if="x.user_id!='1'" class="btn btn-warning btn-xs ng-scope"
                                ng-click="Openmodaledit(x)">ແກ້ໄຂ</button>
                            <button ng-if="showdeletcbut && x.user_id!='1'" class="btn btn-xs btn-danger"
                ...
                <div class="modal-body">
                    ...
                    <fieldset ng-show="listbrand.length != '0'">
                        <div class="form-group">
                            <?=$lang_staffname?>
                            <input class="form-control" placeholder="<?=$lang_staffname?>" ng-model="user_name"
                                type="text" style="height: 50px;font-size: 20px;">
                        </div>

                        <div class="form-group">
                            <select ng-disabled="user_id=='1'" id="" class="form-control" ng-model="user_type"
                        ...
                        <div class="form-group" ng-show="user_type=='9'">
                            <select class="form-control" ng-model="supplier_id" style="height: 50px;font-size: 20px;">
                                ...
                                <option ng-repeat="a in vendorlist" value="{{a.supplier_id}}">{{a.supplier_name}}
                                </option>
                            </select>
                        </div>
	...
	<select id="" class="form-control" ng-model="owner_id" style="height: 50px;font-size: 20px;">
		...
		<option ng-repeat="a in listbrand" value="{{a.owner_id}}">{{a.owner_name}}</option>
                        ...
                        <input id="submit" class="btn btn-lg btn-success btn-block" type="submit" ng-click="Adduser()"
                            value="<?=$lang_save?>" ng-hide="foredit">

                        <input id="submit" class="btn btn-lg btn-success btn-block" type="submit" ng-click="Edituser()"
                            value="<?=$lang_save?>" ng-show="foredit">
                        ...
                        <div class="form-group">
                            <?=$lang_email?>
                            <input class="form-control" placeholder="<?=$lang_email?>" ng-model="user_email" type="text"
                                style="height: 50px;font-size: 20px;">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="<?=$lang_password?>" ng-model="user_password"
                                type="text" style="height: 50px;font-size: 20px;">
                        </div>
...
app.controller('Index', function($scope, $http, $location) {
    ...
    $scope.Adduser = function() {
        ...
        if ($scope.user_email != '' && $scope.owner_id != '0' && $scope.user_name != '' && $scope
            .user_password != '') {
