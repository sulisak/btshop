                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width:20%;"><input type="number" class="form-control"
                                    ng-model="storenamesizelabel"></td>
                ...
                <span ng-show="tcode=='1'" class="noprint">
                    ...
                    <form class="form-inline">
                        <div class="form-group">
                            <input type="text" ng-model="product_name" placeholder="<?php echo $lang_productname;?>"
                                class="form-control" style="font-size:18px;" />
                        </div>
                        <div class="form-group">
                            <input type="text" ng-model="product_code" placeholder="<?php echo $lang_barcode;?>"
                                class="form-control" style="font-size:18px;" />
                        </div>
                        <br />
                        <p></p>
                        <div class="form-group">
                            <input type="text" ng-model="product_price" placeholder="<?php echo $lang_price;?>"
                                class="form-control" style="font-size:18px;" />
                        </div>
                        <div class="form-group">
                            <input type="number" ng-model="num" ng-change="Addnum(num)"
                                placeholder="<?php echo $lang_qty;?>" class="form-control"
                ...
                <span ng-show="tcode=='2'" class="noprint">
                    ...
                    <i ng-repeat="x in datac2">
                        ...
                        <form class="form-inline">
                            ...
                            <div class="form-group">
                                <input type="text" ng-model="x.product_name2"
                                    placeholder="<?php echo $lang_productname;?>" class="form-control"
                                    style="font-size:18px;width:180px;" disabled>
                            </div>
                            <div class="form-group">
                                <input type="text" ng-model="x.product_code2" placeholder="<?php echo $lang_barcode;?>"
                                    class="form-control" style="font-size:18px;width:180px;" disabled>
                            </div>
                            <div class="form-group">
                                <input type="text" ng-model="x.product_price2" placeholder="<?php echo $lang_price;?>"
                                    class="form-control" style="font-size:18px;width:100px" disabled>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-warning" ng-click="Delete($index)"><span
...
foreach ($barcode_array as $value) {
	?>
                    ...
                    <div
                        style="margin-right: {{marginright/2}}px;margin-left: {{marginright/2}}px;margin-bottom: {{marginbottom}}px;margin-top: {{margintop}}px;overflow: hidden;float: left;width: {{widthlabel}}px;height: {{heightlabel}}px;text-align:left;border: dotted;border-width: {{outline}}px;">

                        <center style="padding-left: 10px;padding-right: 10px;">
                            <span ng-if="storenamelabel !=''"
                                style="font-size: {{storenamesizelabel}}px;font-weight:bold;">
                                {{storenamelabel}}
                                <br />
                            </span>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="text" ng-model="searchproduct" placeholder="<?php echo $lang_search;?>"
                                class="form-control" ng-change="Searching(searchproduct)">

                            <table class="table table-bordered">
                                <tr ng-repeat="x in list">
                                    <td><button type="button" class="btn btn-success"
                                            ng-click="Addproduct(x)"><?php echo $lang_select;?></button></td>
...
app.controller('Index', function($scope, $http, $location) {
    ...
    $scope.Addproduct = function(x) {
        $scope.datac2.push({
            product_name2: x.product_name,
            product_code2: x.product_code,
            product_price2: x.product_price
        });
    }
    ...
    $scope.Getall = function() {
        $http.post("barcode_ds_full/getall", {}).success(function(data) {
            $scope.datac2 = data;
