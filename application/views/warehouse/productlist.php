	...
	<thead>
		<tr style="background-color: #eee;">
		 ...
		 <th style="text-align: center;"><?php echo $lang_pl_6;?></th> 
			...
			<th style="text-align: center;">ລາຄາຂາຍຍ່ອຍ 
				
				</th>
			<th style="text-align: center;">ລາຄາຂາຍສົ່ງ</th>
...
<td align="center">
	...
	<center>
<img src="<?php echo $base_url;?>/{{x.product_image}}" class="img img-responsive" width="70px" height="70px;">
<br />
...
<button class="btn btn-primary" ng-click="Updatematmodal(x)" style="width: 120px;font-size:12pt;font-weigth:bold;">
