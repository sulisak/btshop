<div class="col-md-10 col-sm-9" ng-app="firstapp" ng-controller="Index">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
                        ...
                        <td>
                            <form class="form-inline">
                                ...
                                <div class="form-group" style="float:right;">
                                    <input type="number" class="form-control" placeholder="<?php echo $lang_imsn_2;?>"
                                        ng-model="numsnauto">
                                    <input type="number" class="form-control" placeholder="<?php echo $lang_imsn_3;?>"
                                        ng-model="numsnauto2">
                                    <button ng-click="Createsncodeauto()" class="btn btn-warning btn-lg" placeholder=""
                                        title="">
            ...
            <textarea class="form-control" style="height:300px;width:50%;font-size:20px;" ng-model="sn_code"
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    <tr ng-repeat="x in list">
                        ...
                        <td align="center">
                            <button class="btn btn-success" ng-click="Confirm(x)"
                                ng-if="x.confirm=='0'"><?php echo $lang_exp_4;?></button>
                            <span class="badge badge-success" style="background-color: #1fb71f;"
                                ng-if="x.confirm=='1'"><?php echo $lang_exp_5;?></span>
                            ...
                            <a href="<?php echo $base_url; ?>/warehouse/barcode_ds_sn?type=1&im_no={{x.im_no}}&product_name={{x.product_name}}"
                            ...
                            <a href="<?php echo $base_url; ?>/warehouse/barcode_ds_sn?type=2&im_no={{x.im_no}}&product_name={{x.product_name}}"
                                class="btn btn-xs btn-default c2mforhide"
                                onclick="window.open(this.href, 'windowName', 'width=1000, height=700, left=24, top=24, scrollbars, resizable'); return false;">
                                <span class="glyphicon glyphicon-barcode" aria-hidden="true"></span>
                                QRCODE </a>
...
app.controller('Index', function($scope, $http, $location) {
    ...
    $scope.Createsncodeauto = function() {
        ...
        $scope.sncodelines = function() {
            return $scope.sn_code.split(/\r*\n/);
        }
        $scope.sncodelineCount = function() {
            return $scope.sncodelines().length;
        }
