...
<input ng-change="Getpn_detail()" type="text" ng-model="importproduct_header_refcode" placeholder="<?=$lang_refnumber?> , No <?php echo $lang_pcb_13;?>" class="form-control" style="width: 200px;">
</div>
<div class="form-group">
...
<thead>
	...
	<th style="text-align: center;width: 50px;"><?=$lang_rank?></th>
		...
		<th style="text-align: center;">Price Base</th> 
...
<td align="center">
<input type="text" name="lotno" ng-model="x.lotno"  placeholder="lot no." class="form-control">
</td>

<td align="center">
<input type="text" name="date_end" ng-model="x.date_end"  placeholder="01-05-2020" class="form-control">
</td>
...
placeholder="<?php echo $lang_exp_7;?>" style="height: 45px;font-size: 20px;">
</div>
