        ...
        <div class="panel-body">
            ...
            <form class="form-inline">
                <div class="form-group">
                    <input ng-change="Getpn_detail()" type="text" ng-model="importproduct_header_refcode"
                        placeholder="<?=$lang_refnumber?> , No <?php echo $lang_pcb_13;?>" class="form-control"
                        style="width: 200px;">
                </div>
                <div class="form-group">
                    ...
                    <tr>
                        <td>
                            <form class="form-inline">
                                ...
                                <div class="form-group">
                                    <button ng-click="Refresh()" class="btn btn-default btn-lg" placeholder=""
            ...
            <table class="table table-hover table-bordered">
                <thead>
                    <tr class="trheader">
                        ...
                        <th style="text-align: center;">ລາຄາຕົ້ນທຶນ</th>
                        <!-- <th style="text-align: center;">ລາຄາຂາຍຍ່ອຍ</th> -->
                ...
                <tbody>
                    <tr ng-repeat="x in productimportlist">
                        ...
                        <td align="center">
                            <input type="text" name="lotno" ng-model="x.lotno" placeholder="lot no."
                                class="form-control">
                        </td>

                        <td align="center">
                            <input type="text" name="date_end" ng-model="x.date_end" placeholder="01-05-2020"
                                class="form-control">
                        </td>
                        ...
                        <td>
                            <input style="text-align: right;" type="text" ng-model="x.importproduct_detail_num"
                        ...
                        <td>
                            <input style="text-align: right;" type="text" ng-model="x.importproduct_detail_pricebase"
                                class="form-control" placeholder="<?=$lang_costperunit?>">
                        </td>

                        <td>
                            <input style="text-align: right;" type="text"
                                value="{{x.importproduct_detail_pricebase * x.importproduct_detail_num | number:2 }}"
            ...
            <form class="form-inline">
                <div class="form-group">
                    <input type="text" ng-model="searchtext" ng-change="getlist(searchtext,'1')" class="form-control"
                        placeholder="<?=$lang_search?> <?php echo $lang_exp_3_a2;?>" style="width: 300px;">
                </div>
...
<button type="submit" ng-click="getlist('','1')" class="btn btn-default" placeholder="" title="<?=$lang_refresh?>"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></button>
			...
			<td align="right">{{x.date_end}}</td> -->
                        ...
                        <td ng-show="showdeletcbut" align="center">
                            <button class="btn btn-xs btn-danger" ng-if="x.confirm=='0'" ng-click="Deleteimportlist(x)"
                            ...
                            <form class="form-inline">
                                <div class="form-group">
                                    <input type="text" ng-model="product_name" ng-change="Searchproductfind()"
                                        class="form-control" placeholder="<?php echo $lang_exp_7;?>"
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="x in productimportlist">
                                            ...
                                            <td>
                                                <input style="text-align: right;" type="text"
                                                    ng-model="x.importproduct_detail_pricebase" class="form-control"
                                                    placeholder="<?=$lang_costperunit?>">
                                            </td>
                                            <td>
                                                <input style="text-align: right;" type="text"
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <tr ng-repeat="x in importone">
                                        ...
                                        <td align="right">{{ x.importproduct_detail_pricebase | number }}</td>

                                        <td align="right">
                                            {{ x.importproduct_detail_pricebase * x.importproduct_detail_num | number:2 }}
                                        </td>

                                    </tr>
                                    <tr>
                                        <td colspan="6" align="right"><?=$lang_all?></td>
                                        <td align="right" style="font-weight: bold;">{{ importone_sumnum | number }}
                                        </td>
                                        <td></td>
                                        <td align="right" style="font-weight: bold;">{{ importone_sumprice | number:2 }}
                                        </td>
...
app.controller('Index', function($scope, $http, $location) {
    ...
    $scope.Confirm = function(x) {
        $http.post("Importproduct/Confirm", {
    ...
    $scope.Deleteimportlist = function(x) {
        ...
        $http.post("Importproduct/Deleteimportlist", {
            importproduct_header_code: x.importproduct_header_code,
            importproduct_header_refcode: x.importproduct_header_refcode
        }).success(function(response) {
            $scope.getlist();
