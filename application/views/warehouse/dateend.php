                ...
                <table class="table table-hover table-bordered" id="headerTable">
                    ...
                    <tbody>
                        <tr ng-repeat="x in list">
                            ...
                            <td align="right">
                                <span ng-if="x.date_end2 < '<?php echo time();?>'"
                                    style="color:red;">{{x.date_end}}</span>
                            ...
                            <td ng-show="showdeletcbut && x.date_end2 < '<?php echo time();?>'" align="center">
                                <button class="btn btn-xs btn-danger" ng-click="Deleteimportlist(x)"
                                    id="delbut{{x.importproduct_header_id}}">
                                    <?=$lang_goout?></button>

                            </td>

                            <td ng-show="showsalebut" align="center">
                                <button class="btn btn-xs btn-primary" ng-click="Saleimportlist(x)"
                                    id="salebut{{x.importproduct_header_id}}">
                                    <?=$lang_gosale?></button>
                            </td>
...
app.controller('Index', function($scope, $http, $location) {
    ...
    $scope.getlist = function(searchtext, page, perpage) {
        ...
        $http.post("Importproduct/getdateend", {
            ...
            console.log("Raw response from server:", data); // <-- log entire response
