...
$scope.Getonemini = function(x) {
 ...
 // add new ================================
 angular.forEach($scope.morepaylist,function(item){
				 
				 if(item.pay_type_id=='2'){
				 $http.get('https://c2mposonline3.com/demopos/promptpay/?id='+data[0].ppid+'&price='+item.money)
							.then(function(response){
						  $scope.qrimgdata1  =  response.data;                 
						});
				 ...
				 $http.get('https://c2mposonline3.com/demopos/promptpay/?id='+data[0].ppid+'&price='+item.money)
							.then(function(response){
						  $scope.qrimgdata2  =  response.data;                 
						});
