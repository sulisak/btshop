                ...
                <table ng-if="list" id="headerTable" class="table table-hover table-bordered">
                    ...
                    <tbody>
                        <tr ng-repeat="x in list">
                            ...
                            <td style="color:#fff;background-color:#f0ad4e;text-align:right;">
                                {{x.shift_money_end-x.shift_money_start  | number:2}}</td>
                            ...
                            <td style="text-align:right;color:#fff;background-color:#5bc0de;">
                                {{x.sumsale_num-x.pr_num | number}}</td>
                            <td style="color:#fff;background-color:#f0ad4e;text-align:right;">
                                {{x.sumsale_price-x.discount_last-x.pr_price-x.money_from_customer | number:2}}</td>

                            <td ng-if="(x.shift_money_end-x.shift_money_start)-(x.sumsale_price-x.discount_last-x.pr_price-x.money_from_customer) < '0.00'"
                                style="color:#fff;background-color:red;text-align:right;">
                                {{(x.shift_money_end-x.shift_money_start)-(x.sumsale_price-x.discount_last-x.pr_price-x.money_from_customer) | number:2}}
                            </td>
                            <td ng-if="(x.shift_money_end-x.shift_money_start)-(x.sumsale_price-x.discount_last-x.pr_price-x.money_from_customer) > '0.00'"
                                style="color:#fff;background-color:green;text-align:right;">
                                {{(x.shift_money_end-x.shift_money_start)-(x.sumsale_price-x.discount_last-x.pr_price-x.money_from_customer) | number:2}}
                            </td>
                            <td ng-if="(x.shift_money_end-x.shift_money_start)-(x.sumsale_price-x.discount_last-x.pr_price-x.money_from_customer) == '0.00'"
                                style="color:#fff;background-color:blue;text-align:right;">
                                {{(x.shift_money_end-x.shift_money_start)-(x.sumsale_price-x.discount_last-x.pr_price-x.money_from_customer) | number:2}}
                            </td>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <button type="button" class="btn btn-primary"
                            OnClick="Openprintdiv1()"><?=$lang_print?></button>
...
?>
                                    ...
                                    ..............................
                                    <br />
                                    <input type="checkbox" ng-model="hideproduct_shift"><b> <?php echo $lang_srps_13;?>
                                    </b>
                                </center>
                                ...
                                <table class="" style="width: 100%;">
                                    ...
                                    <tbody ng-repeat="x in openbillclosedaylistb">
                                        ...
                                        <tr>
                                            <td><?php echo $lang_discountlast_all;?></td>
                                        ...
                                        <tr ng-repeat="x in openbillclosedaylistb">
                                            ...
                                            <td align="right" style="font-weight:bold;">
                                                {{x.sumsale_price2-x.discount_last2-x.money_from_customer | number:2}}
                                            </td>
                                        </tr>
                                ...
                                <table class="" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="x in openbillclosedaylistc">
                                            ...
                                            <td align="right" ng-if="x.pay_type!='1'">{{x.sumsale_price2 | number:2}}
                                            </td>
