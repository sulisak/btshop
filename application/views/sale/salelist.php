...
<?=$lang_search?> <?php echo $lang_sl_1;?>" ng-change="getlist(searchtext,'1',perpage)">
            ...
            <div id="openprint_table">
                ...
                <center><b>
                        <h1><?php echo $lang_sl_3;?>
                    </b></h1> {{dayfrom}} ເຖິງ {{dayto}} </center>
                    ...
                    <tbody>
                        <tr ng-repeat="x in list">
                            ...
                            <td>
                                ...
                                <button class="btn btn-default btn-xs" ng-click="Getone(x)">{{x.sale_runno}}</button>
                            </td>
                            <td>
...
?>
                            ...
                            <td>{{x.savedate}}</td>
                            <td class="text-right">
                                {{ParsefloatFunc(x.sumsale_price) - x.discount_last - x.price_vat_all | number:2}}</td>
                            ...
                            <td ng-if="showdeletcbut" align="center">
                                ...
                                <?php if(!isset($arr) || $arr[27]->status==true){?>
                                <button title="<?php echo $lang_sl_4;?> {{x.sale_runno}}" class="btn btn-sm btn-danger"
            ...
            <hr />
            <button id="btnExport" class="btn btn-default" onclick="fnExcelReport2();"> <span
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <center style="color:red;">
                                ...
                                <br />
                                <textarea ng-model="whydel" placeholder="<?php echo $lang_sl_7;?>"
                                    class="form-control"></textarea>
                                <br />
                                <button ng-if="whydel" class="btn btn-success btn-lg"
                                    ng-click="Deletelist(deletelist_x)"><?php echo $lang_confirm;?></button>
                            </center>
                        </div>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" style="font-weight: bold;">{{sumsale_price | number:2}}
                                            </td>
...
?>
                                        <tr ng-if="vat3=='0'">
                                            <td align="right" colspan="6"><?=$lang_vat?>
...
?>
                                        ...
                                        <tr>
                                            <td align="right" colspan="6"><?php echo $lang_discountlast;?></td>
                                            <td style="font-weight: bold;" align="right">-{{discount_last2 | number:2}}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" colspan="6"><?=$lang_sumall?></td>
                                            <td style="font-weight: bold;" align="right">
                                                <u>{{ParsefloatFunc(sumsale_price)  * (ParsefloatFunc(vat3)/100) + ParsefloatFunc(sumsale_price) -discount_last2 | number:2}}</u>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" colspan="6"><?=$lang_getmoney?></td>
                                            <td style="font-weight: bold;" align="right">
                                                {{money_from_customer | number:2}}</td>
                                        </tr>
                                        <tr>
                                            <td align="right" colspan="6"><?=$lang_moneychange?></td>
                                            <td style="font-weight: bold;" align="right">
                                                {{money_from_customer-(ParsefloatFunc(sumsale_price)  * (ParsefloatFunc(vat3)/100) + ParsefloatFunc(sumsale_price)-discount_last2) | number:2}}
                                            </td>
                                        </tr>
...
if($_SESSION['owner_tax_number'] !=''){
 ...
 -->
                                    ...
                                    <span ng-if="cus_score != '0.00'"><?php echo $lang_sl_9;?>:
                                        {{cus_score | number}}</span>
                                    <br />
                                    </span>
...
?>
                                    <tr>
                                        ...
                                        <td style="font-weight: bold;" align="right">
                                            {{((sumsalevat*100)/<?php echo $_SESSION['owner_vat']+100; ?>)*(<?php echo $_SESSION['owner_vat'];?>/100) | number:2}}
                                        </td>
                                    </tr>
