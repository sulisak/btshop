...
<input id="customer_name" ng-model="customer_name" class="form-control" placeholder="<?=$lang_cusname?>" style="height: 45px;width: 110px;font-size: 14px;" readonly="">
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo $base_url;?>/mycustomer" class="btn btn-warning btn-lg"
                            onclick="window.open(this.href, 'windowName', 'width=1300, height=700, left=24, top=24, scrollbars, resizable'); return false;">ເພີ່ມລູກຄ້າ</a>
                    </div>
                    <!-- add new customer -->
                                ...
                                <tbody>
                                    ...
                                    <tr ng-repeat="x in listsale" style="background-color:#eee;font-size:18px;">
                                        ...
                                        <td style="text-align:left;">
                                            ...
                                            <button ng-repeat="y in getpotall2data" ng-if="y.product_id==x.product_id"
                                                ng-click="Getpotmodal(x,$index)" class="btn btn btn-default">
...
?>
                        ...
                        <center>
                            ...
                            <div>
                                ...
                                <button ng-if="listsale !=''" id="savequotation" class="btn btn-primary btn-sm ng-scope"
                                    ng-click="Checkbill()">
                                    Check Bill QR</button>
                        ...
                        <div class="modal fade" id="Checkbillmodal" style="display: none;">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div id="printmodal4">
                                            <center>
                                                ...
                                                <b><span
                                                        style="font-size: 16px;"><?php echo $_SESSION['owner_name']; ?></span>
                                                </b>
                                                <b><span style="font-size: 16px;">
                                                        <?php echo $_SESSION['owner_address']; ?></span>
                                                </b>
                                            ...
                                            <div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr ng-repeat="x in listsale">
                                                            ...
                                                            <td width="70%">
                                                                ...
                                                                <br />
                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                {{x.product_sale_num | number}} {{x.product_unit_name}}
                                                                X
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tr ng-if="discount_last!='0'">

                                                        <td align="right">ສ່ວນຫຼດທ້າຍບິນ</td>
                                                        <td align="right">-{{discount_last | number:2}}</td>
                                                    </tr>

                                                    <tr ng-if="discount_last!='0'">

                                                        <td align="right">ຍອດລວມ</td>

                                                        <td align="right" style="font-weight: bold;">
                                                            {{Sumsaleprice()-discount_last | number:2}}
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn btn-primary" onClick="Printmodal4()">
                                            print</button>
                                            ...
                                            <tbody>
                                                <tr ng-repeat="x in productlist" ng-if="x.product_rank !='0'">
                                                    <th><button class="btn btn-default btn-xs"
                                                            ng-click="Delproductranksave(x)">- <?=$lang_exdel?></button>
                                                    </th>
                                                    <th>{{x.product_name}}</th>
                                                    <th>{{x.product_price}}</th>
                                                </tr>
...
?>
                                    ...
                                    <table width="100%" style="text-align: center;white-space: nowrap;">
                                        <tr ng-repeat="y in getonepaylist">
                                            <td>{{y.pay_type_name}}</td>
                                            <td>{{y.money | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
                            ...
                            <div class="modal-footer">
                                ...
                                <center>
                                    <button type="button" class="btn btn-danger btn-lg" data-dismiss="modal"
                                        aria-hidden="true">ປິດໜ້ານີ້(Esc)</button>
                                </center>
                                                    ...
                                                    <tbody>
                                                        <tr ng-repeat="x in list">
                                                            ...
                                                            <td>
                                                                ...
                                                                <button ng-show="printer_ul !='0'"
                                                                    class="btn btn-primary btn-sm"
                                                                    ng-click="printDivminiip2(x)">ພິມສະລີບ
                                                                    (Slip)</button>
...
?>
		...
		?>
                                    ...
                                    $scope.Updateproductnumber = function(x, index) {
                                        ...
                                        $http.post("Salepic/updateproductnumber", {
                                            ...
                                            if (data.cansale == '0') {
                                                ...
                                                toastr.warning('<?php echo $lang_sp_127;?>');
                                            }
                                    ...
                                    $scope.Savesale = function(changemoney, sumsalepricevat, discount_last) {
                                        ...
                                        if ($scope.listsale == '' || $scope.listsale[0].product_id ===
                                            null) {

                                            console.log("Product ID:", $scope.listsale[0]
                                                ?.product_id); // Log product_id
                                            console.log("Full listsale:", $scope
                                                .listsale); // Log full object for debugging
...
{ ?>
                                    ...
                                    $scope.Getonemini = function(x) {
                                        ...
                                        // first call - get more pay info
                                        $http.post("Salelist/Seemorepay", {
                                                sale_runno: x.sale_runno
                                            })
                                            .then(function(response) {
                                                $scope.getonepaylist = response.data;

                                                // loop through payments
                                                angular.forEach($scope.getonepaylist, function(item) {

                                                    if (item.pay_type_id == '2') {
                                                        $http.get(
                                                                '<?php echo $base_url;?>/promptpay/?id=' +
                                                                $scope.getonepaylist[0].ppid +
                                                                '&price=' + item.money)
                                                            .then(function(res) {
                                                                $scope.qrimgdata1 = res
                                                                    .data;
                                                            });
                                                    }

                                                    if (item.pay_type_id == '5') {
                                                        $http.get(
                                                                '<?php echo $base_url;?>/promptpay/?id=' +
                                                                $scope.getonepaylist[0].ppid +
                                                                '&price=' + item.money)
                                                            .then(function(res) {
                                                                $scope.qrimgdata2 = res
                                                                    .data;
                                                            });
                                                    }
                                        ...
                                        // second call - get sale details
                                        $http.post("Salelist/Getone", {
                                                sale_runno: x.sale_runno
                                            })
                                            .then(function(response) {
                                                $scope.listone = response.data;
                                                $scope.cus_name = x.cus_name;
                                    ...
                                    $scope.SaveSubmit = function(cusname, cusaddress, custel, cusemail,
                                        cusremark) {
                                        ...
                                        if (cusname != '') {
                                            ...
                                            $http.post("Mycustomer/save", {
                                                ...
                                                $('#modal-id').modal('hide');
                                                $scope.getmycustomer($scope.searchtype, $scope
                                                    .searchtext, $scope.page, $scope.perpage);
                                ...
                                function Printmodal4() {



                                    var divToPrint = document.getElementById(
                                        'printmodal4'); // เลือก div id ที่เราต้องการพิมพ์
                                    var html = '<html>' + // 
                                        '<head>' +
                                        ...
                                        '<link rel="preconnect" href="https://fonts.gstatic.com"><link href="https://fonts.googleapis.com/css2?family=Chakra+Petch:wght@500&family=Kanit:wght@400&family=Prompt:wght@400&family=Chakra+Petch:wght@400&family=Taviraj:wght@400&family=Sarabun:wght@400&family=Thasadith:wght@400&family=Mitr:wght@400&family=Itim:wght@400&family=Trirong:wght@400&family=Mali:wght@400&family=Krub:wght@400&family=Bai+Jamjuree:wght@400&family=Pridi:wght@400&family=Sriracha:wght@400&family=Pattaya:wght@400&family=Charm:wght@400&family=Niramit:wght@400&family=Maitree:wght@400&family=Athiti:wght@400&family=Chonburi:wght@400&family=K2D:wght@400&family=Srisakdi:wght@400&family=Kodchasan:wght@400&family=KoHo:wght@400&family=Charmonman:wght@400&family=Fahkwang:wght@400&display=swap" rel="stylesheet">' +
                                        '</head>' +
                                ...
                                <script>
                                // function Printmodal4() {
                                //     var divToPrint = document.getElementById('printmodal4');
                                ...
                                //         '<style> .modal-only { display: none !important; } </style>' +
                                //         '</body>' +
                                //         '</html>';
