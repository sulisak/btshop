        ...
        <div class="col-md-4">
            ...
            <!-- <div class="col-md-6">
                <a style="text-decoration:none" href="<?php echo $base_url;?>/sale/product_value"
                    title="ຄິກເບີ່ງ ມຸນຄ່າສິນຄ້າທັງໝົດ">
                    <div class="panel"
                        style="text-align: left;height: 400px;background-color: rgba(12, 162, 22, 0.5);color: #fff;">
                        <br />
                        <center><b><?=$lang_productwillout?></b>
                            <img ng-if="!product_value_list" src="<?php echo $base_url;?>/pic/loading.gif">
                            <table ng-if="product_value_list" ...>
                                <tr ng-repeat="x in product_value_list">
...
<?php echo $lang_db_13;?>
            ...
            <!-- <a href="https://svnssoft.com/salev3/backup_all" class="btn btn-info" style="font-size: 25px;font-weight: bold; width: 500px;height:170px;">
