...
<font style="font-family:Phetsarath OT">
    ...
    <div id="money_change_showcus" class="container" ng-app="firstapp" ng-controller="Index"
        style="display:none;margin-left: 0px; padding-left: 0px; padding-right: 0px; margin-right: 0px;width: 100%;">
                ...
                <tr>
                    <td>
                        ...
                        <div id="myCarousel" class="carousel slide" data-ride="carousel"
                            data-interval="<?php echo $changetime;?>" style="display:none;">
                            <!-- Indicators -->
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="<?php echo $base_url;?>/<?php echo $image1;?>"
                                        style="width:100%;height:<?php echo $picheight;?>px;">

                                </div>

                                <div ng-if="bannerlist[0].image2!=''" class="item">
                                    <img src="<?php echo $base_url;?>/<?php echo $image2;?>"
                                        style="width:100%;height:<?php echo $picheight;?>px;">
                                </div>

                                <div ng-if="bannerlist[0].image3!=''" class="item">
                                    <img src="<?php echo $base_url;?>/<?php echo $image3;?>"
                                        style="width:100%;height:<?php echo $picheight;?>px;">
                                </div>

                                <div ng-if="bannerlist[0].image4!=''" class="item">
                                    <img src="<?php echo $base_url;?>/<?php echo $image4;?>"
                                        style="width:100%;height:<?php echo $picheight;?>px;">
                                </div>

                                <div ng-if="bannerlist[0].image5!=''" class="item">
                                    <img src="<?php echo $base_url;?>/<?php echo $image5;?>"
                                        style="width:100%;height:<?php echo $picheight;?>px;">
                                </div>
                        ...
                        <div ng-if="bannerlist[0].image1==''" class="video-container">
                            ...
                            <iframe width="100%" height="100%"
                                src="https://www.youtube.com/embed/<?php echo $my_array_of_vars['v'];?>?autoplay=1&loop=1&playlist=<?php echo $my_array_of_vars['v'];?>"
                            ...
                            <center>
                                <img ng-if="listsale[listsale.length-1].product_image != ''"
                                    ng-src="<?php echo $base_url?>/{{listsale[listsale.length-1].product_image}}"
        ...
        <div class="panel panel-default col-md-4" style="font-size:20px;font-weight:bold;">
            <div class="panel-body">
                ...
                <div ng-if="showcusnamescore!='' && showcusnamescore.cus_name_show!=''">
                    <b>
                        <center>ຊື່ລູກຄ້າ: {{showcusnamescore.cus_name_show}} ມີ
                            {{showcusnamescore.customer_score_show | number}} point
                        </center>
                    </b>
                </div>
                        ...
                        <tbody style="color:#000;">
                            <tr ng-repeat="x in listsale">
                                ...
                                <td width="15%" align="center">
                                    ...
                                    <span ng-if="x.product_price_discount=='0.00'"> {{x.product_sale_num | number}}
                                    </span>
                                    <span ng-if="x.product_price_discount!='0.00'" style="font-size:30px;">
                                        {{x.product_sale_num | number}} </span>
                                    <?php }else{ ?>
                                ...
                                <td width="20%" class="text-right">
                                    ...
                                    <p ng-if="x.product_price_discount!='0.00'" style="font-size:12px;">
                                        ...
                                        <span style="color:red;"> -{{x.product_price_discount | number:2}} </span>
                                    </p>
                                    <?php } ?>
                                ...
                                <td width="20%" class="text-right">
                                    ...
                                    <p ng-if="x.product_price_discount!='0.00'" style="font-size:12px;">
                                        <span style="color:green;">
                                            {{x.product_price* x.product_sale_num | number:<?php echo $_SESSION['decimal_print']; ?>}}
                                            <span style="color:red;">
                                                -{{x.product_price_discount* x.product_sale_num | number:2}} </span>
                                    </p>
                                    <?php } ?>
                ...
                <table class="table" style="background-color: #fcf8e3;">
                    <tr>
                        ...
                        <td align="right" style="font-size:30px;font-weight:bold;">
                            {{Sumsaleprice() | number:<?php echo $_SESSION['decimal_print']; ?> }}</td>
                    </tr>
                    <tr>
                        <td colspan="2" style="font-size:30px;font-weight:bold;">ສ່ວນຫຼຸດທ້າຍບິນ</td>
                        <td align="right" style="font-size:30px;font-weight:bold;color:red;">
                            -{{discount_last | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
                    </tr>
                    <tbody>
                        ...
                        <tr
                            ...
                            <td colspan="2" align="right"
                                style="color:#000;font-size:60px;font-weight: bold;border:1px solid orange;">
                                {{Sumsaleprice()-discount_last | number:<?php echo $_SESSION['decimal_print']; ?> }}
                            </td>
        ...
        <div class="col-md-12">
            <center>
                <button class="btn btn-default btn-xs" ng-click="Updateimagemodal()">
                    <span class="glyphicon glyphicon-cog" aria-hidden="true"><span style="font-family: 'Phetsarath OT'">
                            ຕັ້ງຄ່າ</span></button>
                <div>
            </center>
            <?php } ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" style="font-family:Phetsarath OT"><span>ຕັ້ງຄ່າ</span></h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <img ng-if="bannerlist[0].image2!=''" src="<?php echo $base_url;?>/<?php echo $image2;?>"
                                style="width:50px;height:50px;">
                            <button ng-if="bannerlist[0].image2!=''" class="btn btn-danger btn-xs"
                                ng-click="Delimage('2')">x</button>


                            <img ng-if="bannerlist[0].image3!=''" src="<?php echo $base_url;?>/<?php echo $image3;?>"
                                style="width:50px;height:50px;">
                            <button ng-if="bannerlist[0].image3!=''" class="btn btn-danger btn-xs"
                                ng-click="Delimage('3')">x</button>




                            <img ng-if="bannerlist[0].image4!=''" src="<?php echo $base_url;?>/<?php echo $image4;?>"
                                style="width:50px;height:50px;">
                            <button ng-if="bannerlist[0].image4!=''" class="btn btn-danger btn-xs"
                                ng-click="Delimage('4')">x</button>




                            <img ng-if="bannerlist[0].image5!=''" src="<?php echo $base_url;?>/<?php echo $image5;?>"
                                style="width:50px;height:50px;">
                            <button ng-if="bannerlist[0].image5!=''" class="btn btn-danger btn-xs"
                                ng-click="Delimage('5')">x</button>
                            ...
                            <form id="uploadImg" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="picheight" name="picheight" class="form-control"
                                        placeholder="945" style="width:100px;">
                                </div>

                                <div class="form-group">
                                    ເວລາໃນການປ່ຽນພາບ ວິນາທີ ຄ່າປົກກະຕິ 5
                                    <input type="text" id="changetime" name="changetime" class="form-control"
                                        placeholder="5" style="width:100px;">
                                </div>


                                <div class="form-group">
                                    ຄວາມສູງຂອງກ່ອງສະແດງລາຍການສິນຄ້າ ຄ່າປົກກະຕິ 560
                                    <input type="text" id="saleboxheight" name="saleboxheight" class="form-control"
                                        placeholder="560" style="width:100px;">
                                </div>


                                <div class="form-group">
                                    ສະແດງລາຄາຕໍ່ໜ່ວຍ
                                    <select class="form-control" id="show_pricepernum" name="show_pricepernum"
                                        style="width:100px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="show_discount_text" name="show_discount_text"
                                        style="width:100px;">
                                        <option value="0">ສະແດງ</option>
                                        <option value="1">ບໍ່ສະແດງ</option>
                                    </select>
            ...
            <div class="modal fade" id="openchangmoney">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body"
                            ng-if="money_change_showcus[0].money_change_showcus!='0.01' && listsale==''">



                            <center>
                                <?=$lang_moneyback?> <br />
                                <span class="text-right" style="color:green;font-size:200px;font-weight:bold;">
                                    {{money_change_showcus[0].money_change_showcus | number:2}}</span>
                            ...
                            <table class="table" style="font-size:40px;font-weight:bold;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?=$lang_getmoneycus?></td>
                                    <td class="text-right">{{money_change_showcus[0].money_from_cus_showcus | number:2}}
                                    </td>

                                </tr>
                                <tr>
                                    <td class="text-right"> <?=$lang_moneyallget?></td>
                                    <td class="text-right">-{{money_change_showcus[0].price_value_showcus | number:2}}
                                    </td>
...
app.controller('Index', function($scope, $http) {
    ...
    $scope.money_change_showcus = [{
        money_change_showcus: ''
    }];
    ...
    $scope.Showlistorder = function() {
        ...
        $http.post("<?php echo $base_url;?>/sale/Salepic/showlistorder", {}).success(function(data) {
            $scope.listsale = data;
        });
    ...
    $scope.Showbannerlist = function() {
        ...
        $http.post("<?php echo $base_url;?>/home/Getimgbanner", {}).success(function(data) {
    ...
    $scope.Showmoney_change = function() {
        ...
        $http.post("<?php echo $base_url;?>/sale/Salepic/showmoneychange", {}).success(function(data) {
            $scope.money_change_showcus = data;
        });

        $http.post("<?php echo $base_url;?>/sale/Salepic/Sesdiscount2", {}).success(function(data) {
            $scope.discount_last = data;
        });


        $http.post("<?php echo $base_url;?>/sale/Salepic/showcusnamescore", {}).success(function(data) {
    ...
    $scope.Getround = function() {
        $http.post("<?php echo $base_url;?>/salesetting/round_setting/getround", {}).success(function(
            data) {
