<?php $fontfamily_bill = 'font-family: "'.$_SESSION['fontslip'].'", sans-serif;';?>
<?php $fontfamily_ui = 'font-family: "'.$_SESSION['fontc2m'].'", sans-serif;';?>
...
function Openprintdiv1() {
    ...
    var html = '<html>' + // 
        ...
        '<style> body{<?php echo $fontfamily_bill;?>}</style>' +
        '</html>';
