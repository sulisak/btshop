    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <font size="4"><span class="glyphicon glyphicon-th" aria-hidden="true"></span>
                <?=$lang_cusnamelist?> ({{allmycustomer | number:0}} <?=$lang_person?>) <a class="btn btn-primary"
                    style="float: right" ng-click="Openaddnewcus()">
...
<button class="btn btn-info"  ng-click="DownloadExcel()" title="ดาวน์โหลดรายชื่อลูกค้า" ><span class="glyphicon glyphicon-save" aria-hidden="true"></button>
                ...
                <div class="form-group">
                    <button type="submit" ng-click="Refreshsubmit(searchtype,searchtext,'1')" class="btn btn-default"
                        placeholder="" title="<?=$lang_refresh?>"><span class="glyphicon glyphicon-refresh"
                ...
                <table class="table table-hover" id="headerTable">
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="x in mycustomer">
                            <td ng-if="selectpage=='1'" class="text-center visible-sm visible-md visible-lg">
                                {{($index+1)}}</td>
                            <td ng-if="selectpage!='1'" class="text-center visible-sm visible-md visible-lg">
                            ...
                            <td width="70px">
                                ...
                                {{x.cus_add_time}}
                                <a ng-if="x.cus_add_time !=''" class="btn btn-default btn-xs c2mforhide" target="_blank"
                                    href="<?php echo $base_url;?>/card?code={{x.cus_add_time}}&cus_name={{x.cus_name}}"><span
                                        class="glyphicon glyphicon-credit-card" aria-hidden="true"></span> </a>
                            ...
                            <td width="70px">
                                <button class="btn btn-warning btn-xs" ng-click="Editrow(x)"><span
                                        class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>
                                <button ng-if="Showdelbut" class="btn btn-danger btn-xs" id="deletecustomer"
                                    ng-click="Delete(x.cus_id)"><span class="glyphicon glyphicon-trash"
                                        aria-hidden="true"></span></button>
                            </td>
            ...
            <form class="form-inline">
                <div class="form-group">
                    ...
                    <select class="form-control" name="" id="" ng-model="perpage"
                        ng-change="getmycustomer(searchtype,searchtext,'',perpage)">
                    ...
                    <select name="" id="" class="form-control" ng-model="selectthispage"
                        ng-change="getmycustomer(searchtype,searchtext,selectthispage,perpage)">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="<?php echo $lang_memberid;?>" name=""
                                ng-model="cus_add_time" class="form-control" required>
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="<?=$lang_cusname?>" name="" class="form-control"
                                ng-model="cusname" required>
                        ...
                        <div class="col-md-12">
                            <textarea name="" class="form-control" placeholder="<?=$lang_address?>"
                                ng-model="cusaddress">
</textarea>
                        </div>
                        ...
                        <div class="col-md-4">
                            <input type="text" placeholder="<?php echo $lang_obmt_6;?>" name="" class="form-control"
                                ng-model="cusaddresspostcode">
                        ...
                        <div class="col-md-4">
                            <input type="text" placeholder="<?=$lang_tel?>" onkeypress="validate(event)"
                                ng-change="Checktel()" name="" class="form-control" ng-model="custel">
                            <span ng-if="checktelstatus > '0'" style="color:red;"><?php echo $lang_obmt_7;?> </span>
                        </div>

                        <div class="col-md-4">

                            <input data-format="dd/MM/yyyy" type="text" placeholder="<?=$lang_birthday?>" id="datetime"
                                name="datetime" class="form-control" ng-model="cusbirthday">
                        ...
                        <div class="col-md-6">
                            <input type="text" placeholder="<?php echo $lang_obmt_8;?>" name="" class="form-control"
                                ng-model="taxnumber">
                        ...
                        <div class="col-md-4">
                            <select name="" id="" class="form-control" ng-model="customer_sex">
                                ...
                                <option ng-repeat="s in customersex" value="{{s.customer_sex_id}}">
                                    {{s.customer_sex_name}}</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            <select name="" id="" class="form-control" ng-model="customer_group">
                                ...
                                <option ng-repeat="g in customergroup" value="{{g.customer_group_id}}">
                                    {{g.customer_group_name}}</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            <select name="" id="" class="form-control" ng-model="customer_level">
                                ...
                                <option ng-repeat="l in customerlevel" value="{{l.customer_level_id}}">
                                    {{l.customer_level_name}}</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            <center>
                                ...
                                <input type="text" style="width:70px;" placeholder="0 <?php echo $lang_date;?>" name=""
                                    class="form-control" ng-model="credit_day">
                            </center>
                        </div>
                        ...
                        <div class="col-md-6">
                            <center>
                                ...
                                <input type="text" style="width:70px;" placeholder="<?php echo $lang_obmt_11;?>" name=""
                                    class="form-control" ng-model="credit_limit">
                            </center>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button ng-if="checktelstatus == '0'" type="submit" class="btn btn-success" id="savenewcustomer"
                        ng-click="SaveSubmit(cusname,cusaddress,custel,cusemail,cusremark)"><?=$lang_save?></button>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="<?php echo $lang_memberid;?>" name="" class="form-control"
                                ng-model="cus_add_time" disabled>
                        ...
                        <div class="col-md-4">
                            <input type="text" placeholder="<?php echo $lang_obmt_6;?>" name="" class="form-control"
                                ng-model="cusaddresspostcode" disabled>

                        </div>

                        <div class="col-md-4">
                            <input type="text" placeholder="<?=$lang_tel?>" name="" class="form-control"
                                ng-model="custel" disabled>
                        </div>

                        <div class="col-md-4">

                            <input data-format="dd/MM/yyyy" type="text" placeholder="<?=$lang_birthday?>" id="datetime2"
                                name="datetime2" class="form-control" ng-model="cusbirthday" disabled>
                        ...
                        <div class="col-md-6">
                            <center>
                                <?php echo $lang_obmt_9;?>
                                <input type="text" style="width:70px;" placeholder="0 <?php echo $lang_date;?>" name=""
                                    class="form-control" ng-model="credit_day" disabled>
                            </center>
                        </div>
                        ...
                        <div class="col-md-6">
                            <center>
                                <?php echo $lang_obmt_10;?>
                                <input type="text" style="width:70px;" placeholder="<?php echo $lang_obmt_11;?>" name=""
                                    class="form-control" ng-model="credit_limit" disabled>
                            </center>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <input type="text" placeholder="<?php echo $lang_memberid;?>" name="" class="form-control"
                                ng-model="cus_add_time" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input data-format="dd/MM/yyyy" type="text" placeholder="<?=$lang_birthday?>" id="datetime3"
                                name="datetime3" class="form-control" ng-model="cusbirthday">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">close</button>
                    <button ng-if="checktelstatus == '0'" type="submit" class="btn btn-success" id="editcustomer"
                        ng-click="EditSubmit(cusid,cusname,cusaddress,custel,cusemail,cusremark)"><?=$lang_save?></button>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <button class="btn btn-primary" ng-click="Newcontactmodal(cusid)"><span
                                class="glyphicon glyphicon-plus" aria-hidden="true"></button>
                        <?=$lang_cuscontactlist?> / {{cusname}}
                    </h4>
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <tr ng-repeat="c in contactlistone">
                                        ...
                                        <td>{{c.addtime}}</td>
                                        <td width="70px"><button class="btn btn-warning btn-xs"
                                                ng-click="Contactedit(c)"><span class="glyphicon glyphicon-pencil"
                                                    aria-hidden="true"></span></button> <button
                                                class="btn btn-danger btn-xs" ng-show="showdel"
                                                ng-click="Contactdelete(c)"><span class="glyphicon glyphicon-trash"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <textarea class="form-control" ng-model="contact_list_detail"
                                placeholder="<?=$lang_detailcontact?>"></textarea>
                        </div>
                        ...
                        <div class="col-md-4">
                            <select name="" id="" class="form-control" ng-model="contact_from_id">
                                ...
                                <option ng-repeat="s in contactfrom" value="{{s.contact_from_id}}">
                                    {{s.contact_from_name}}</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <select name="" id="" class="form-control" ng-model="contact_grade_id">
                                <option value="">-<?=$lang_selectgrade?>-</option>
                                <option ng-repeat="s in contactgrade" value="{{s.contact_grade_id}}">
                                    {{s.contact_grade_name}}</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <select name="" id="" class="form-control" ng-model="product_service_id">
                                <option value="">-<?=$lang_selectproductservice?>-</option>
                                <option ng-repeat="s in productservice" value="{{s.product_service_id}}">
                                    {{s.product_service_name}}</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            <select name="" id="" class="form-control" ng-model="customer_reasonbuy_id">
                                ...
                                <option ng-repeat="s in customerreasonbuy" value="{{s.customer_reasonbuy_id}}">
                                    {{s.customer_reasonbuy_name}}</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <select name="" id="" class="form-control" ng-model="customer_reasonnotbuy_id">
                                <option value="">-<?=$lang_selectreasonnotbuy?>-</option>
                                <option ng-repeat="s in customerreasonnotbuy" value="{{s.customer_reasonnotbuy_id}}">
                                    {{s.customer_reasonnotbuy_name}}</option>
                            </select>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">close</button>
                    <button type="submit" class="btn btn-success" id="editcustomer"
                        ng-click="SaveContact()"><?=$lang_save?></button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">close</button>
                    <button type="submit" class="btn btn-success" id="editcustomer"
                        ng-click="SaveContactedit()"><?=$lang_save?></button>
                </div>
            </div>
...
app.controller('Index', function($scope, $http, $location) {
    ...
    $scope.pregetlistcus = function() {
        ...
        setTimeout(function() {
            ...
            if ($scope.csearchtextarray2[0] == $scope.csearchtextarray[$scope.csearchtextarray
                    .length - 1]) {
                $scope.getmycustomer();
            }
            $scope.csearchtextarray = [];
    ...
    $scope.SaveSubmit = function(cusname, cusaddress, custel, cusemail, cusremark) {
        ...
        if (cusname != '') {
            ...
            $http.post("Mycustomer/save", {
                ...
                $('#modal-id').modal('hide');
                $scope.getmycustomer($scope.searchtype, $scope.searchtext, $scope.page, $scope
                    .perpage);
