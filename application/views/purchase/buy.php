                        ...
                        <td>
                            <form class="form-inline">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="product_code" ng-model="product_code"
                                ...
                                <div class="form-group">
                                    <button ng-click="Searchvendor()" class="btn btn-info btn-lg" placeholder=""
                                        title="">
...
<?=$lang_fullscreen?>
 ...
 <?php echo $lang_pcb_2;?>" class="form-control" style="width: 200px;">
                ...
                <div class="form-group">
                    <input class="form-control" style="width: 500px;" ng-model="importproduct_header_remark"
                        placeholder="<?=$lang_remark?>">
                </div>
			...
			{{x.zone_name}}
				...
				<input style="text-align: right;" type="text" ng-model="x.importproduct_detail_pricebase" class="form-control" placeholder="<?=$lang_costperunit?>">
                        ...
                        <td>
                            <input onkeypress="validate(event)" style="text-align: center;" ng-change="Savedraffsess()"
                                style="text-align: left;" type="text" ng-model="x.importproduct_detail_num"
                                class="form-control" placeholder="<?=$lang_unit?>">
                        </td>
                        <td align="center">
                            {{x.product_unit_name}}
                        </td>
				...
				<input style="text-align: right;" type="text" value="{{x.importproduct_detail_pricebase * x.importproduct_detail_num | number:2 }}" class="form-control" readonly>
                        ...
                        <td>
                            <input onkeypress="validate(event)" style="text-align: center;" ng-change="Savedraffsess()"
                                style="text-align: left;" type="text" ng-model="x.price_per_num" class="form-control"
                                placeholder="">
                        </td>
                        ...
                        <td><button class="btn btn-sm btn-danger"
                                ng-click="Deletepush($index)"><?=$lang_delete?></button></td>
                    </tr>
            ...
            <button id="Saveimportproduct" class="btn btn-success btn-lg" style="float: right;"
                ng-click="Saveimportproduct()"><?=$lang_save?></button>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <form class="form-inline">
                ...
                <div class="form-group">
                    <input type="text" ng-model="searchtext" ng-change="getlist(searchtext,'1',perpage)"
                        class="form-control" placeholder="<?=$lang_search?> <?php echo $lang_pcb_4_1_1;?>"
                        style="width: 300px;">
                </div>
...
<button type="submit" ng-click="getlist('','1')" class="btn btn-default" placeholder="" title="<?=$lang_refresh?>"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></button>
                ...
                <table class="table table-hover table-bordered" id="headerTable">
                    ...
                    <tbody>
                        <tr ng-repeat="x in list">
                            ...
                            <td align="center"><button class="btn btn-default btn-sm"
                                    ng-click="Getimportone(x)">{{x.importproduct_header_code}}</button></td>
                            ...
                            <td align="center" ng-if="x.status =='0'">
                                <span ng-if="showinstockbut">
                                    <a href="<?php echo $base_url;?>/warehouse/importproduct?pn={{x.importproduct_header_code}}"
                            ...
                            <td align="center" ng-if="x.status =='1'"
                                style="color:#fff;background-color:green;font-size:12px;font-weight:bold;">
                                Instock
                            </td>
                            ...
                            <td ng-if="showdeletcbut && x.status =='0'" align="center">
                                <button class="btn btn-xs btn-danger" ng-click="Deleteimportlist(x)"
                                    id="delbut{{x.importproduct_header_id}}"><?=$lang_delete?></button>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="form-inline">
                                <div class="form-group">
                                    <input type="text" ng-model="product_name" ng-change="Searchproductfind()"
                                        class="form-control" placeholder="<?php echo $lang_stkc_8_a3;?>"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="form-inline">
                                <div class="form-group">
                                    <input type="text" ng-model="searchtextsetting"
                                        ng-change="Searchsettingproductfind()" class="form-control"
                                ...
                                <tbody>
                                    <tr ng-repeat="x in settingproductlist">
                                        ...
                                        <td style="text-align:center;">
                                            <input onkeypress="validate(event)" style="text-align: center;" type="text"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="form-inline">
                                <div class="form-group">
                                    <input type="text" ng-model="vendor_name_search" ng-change="Searchvendorfind()"
                                        class="form-control" placeholder="<?php echo $lang_search;?>"
                                        style="height: 45px;font-size: 20px;">
                                </div>
                ...
                <div class="modal-dialog modal-lg" style="width: 100%;margin: 0px;">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form class="form-inline">
                                <div class="form-group">
                                    <input type="text" ng-model="importproduct_header_refcode"
                                        placeholder="<?=$lang_refnumber?>" class="form-control" style="width: 200px;">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" style="width: 500px;"
                                        ng-model="importproduct_header_remark" placeholder="<?=$lang_remark?>">
                                </div>
                            </form>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form class="form-inline">
                                                ...
                                                <div class="form-group">
                                                    <button ng-click="Searchproduct()" class="btn btn-primary btn-lg"
                                                        placeholder="" title="ค้นหา"><span
                                                            class="glyphicon glyphicon-refresh"
                                                            aria-hidden="true"></span></button>
                                                </div>
				...
				<input style="text-align: right;" type="text" ng-model="x.importproduct_detail_pricebase" class="form-control" placeholder="<?=$lang_costperunit?>">
                                            ...
                                            <td>
                                                <input style="text-align: right;" type="text"
                                                    ng-model="x.importproduct_detail_num" class="form-control"
                                                    placeholder="<?=$lang_unit?>">
                                            </td>
                                            <!-- <td>
				<input style="text-align: right;" type="text" value="{{x.importproduct_detail_pricebase * x.importproduct_detail_num | number:2 }}" class="form-control" readonly>
			</td> -->
                            ...
                            <table width="100%">
                                <tr>
                                    <td align="center" style="font-size: 16px;"><?=$lang_salenumall?> <span
                                            style="font-weight: bold;">{{Sumnum() | number}}</span>
                            ...
                            <table width="100%">
                                <tr>
                                    <td align="right">
                                        <button id="Saveimportproduct2" class="btn btn-success btn-lg"
                                            style="float: right;"
                                            ng-click="Saveimportproduct()"><?=$lang_save?></button>
                                    </td>
                                </tr>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="openprint1">
                            ...
                            <table ng-if="getvendor_name !=''" class="table table-bordered"
                            ...
                            <table class="table table-bordered" width="100%">
                                <tr>
                                    ...
                                    <td>{{importproduct_header_code}}</td>
                                    <td align="right"><?=$lang_day?>:</td>
                                    <td>{{importproduct_header_date2}}</td>
                                </tr>
                                <tr>
                                    <td align="right"><?=$lang_refnumber?>:</td>
                                    <td>{{importproduct_header_refcode2}}</td>
                                    <td align="right"><?=$lang_remark?>:</td>
                                    <td>{{importproduct_header_remark2}}</td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <tr ng-repeat="x in importone">
                                        ...
                                        <td align="right">{{ x.price_per_num* x.importproduct_detail_num | number:2 }}
                                        </td>

                                    </tr>
                                    <tr>
                                        <td colspan="3" align="right"><?=$lang_all?></td>
                                        <td align="right" style="font-weight: bold;">{{ importone_sumnum | number:2 }}
                                        </td>
                                        <td>
    ...
    font-size: 35px;">
                                ...
                                <button type="button" class="btn btn-primary btn-lg"
                                    data-dismiss="modal"><?php echo $lang_confirm;?></button>
            ...
            <div class="modal fade" id="Modalproduct" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="text" ng-model="searchproduct" placeholder="<?=$lang_search?>"
            ...
            <div class="modal fade" id="Product_orderprint_modal">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h1 class="modal-title text-center" style="color:blue;"><b><?php echo $lang_db_30;?></b>
                            </h1>
                            <center> <a href="<?php echo $base_url;?>/purchase/buy/Remove_orderprint_modal2"
...
app.controller('Index', function($scope, $http, $location) {
    ...
    $scope.productimportlist =
        <?php echo json_encode($_SESSION['purchase_buy_productimportlist'],JSON_UNESCAPED_UNICODE);?>;
    <?php }else{ ?>
    $scope.productimportlist = [];
    <?php } ?>
    ...
    $scope.Product_orderprint = function() {
        ...
        $http.post("<?php echo $base_url;?>/purchase/buy/Product_orderprint2", {}).success(function(data) {
    ...
    $scope.Getproductautofordraff = function() {
        $http.post("buy/Getproductautofordraff", {}).success(function(data) {
    ...
    $scope.Sumnumprice = function() {
        ...
        angular.forEach($scope.productimportlist, function(item) {
            ...
            if ($scope.vat_type == '0') {
                ...
                if (item.have_vat == '0') {
                    all = (item.importproduct_detail_num * item.price_per_num) + (item
                        .importproduct_detail_num * item.price_per_num) * (
                        <?php echo $_SESSION['vat']?> / 100);
                } else {
    ...
    $scope.Saveimportproduct = function() {
        if ($scope.productimportlist != '') {
            ...
            if ($scope.productimportlist[0].product_id != '' && $scope.productimportlist[0]
    ...
    $scope.Sumvat = function() {
        ...
        angular.forEach($scope.productimportlist, function(item) {
            ...
            if (item.have_vat == '0') {
                ...
                if ($scope.vat_type == '0') {
                    all = (item.importproduct_detail_num * item.price_per_num) * (
                        <?php echo $_SESSION['vat']?> / 100);
                } else {
                    all = ((item.importproduct_detail_num * item.price_per_num * 100) / (
                        <?php echo $_SESSION['vat'];?> + 100)) * (
                        <?php echo $_SESSION['vat'];?> / 100);
                }
